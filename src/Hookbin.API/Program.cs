...
using Hookbin.Application;
using Hookbin.Infrastructure;
using Hookbin.Infrastructure.Persistence;
using AuthOptions = Hookbin.API.Options.AuthOptions;
using AuthOptionsValidator = Hookbin.API.Options.AuthOptionsValidator;
using WebhookOptionsValidator = Hookbin.API.Options.WebhookOptionsValidator;
...
var webhookOptions = builder.Configuration.GetSection("Hookbin").Get<WebhookOptions>()
    ?? new WebhookOptions();
