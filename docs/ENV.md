...
## .env File Quoting Rules

The Docker Compose loader interpolates variables. Be aware of:

```env
# OK: Double quotes — value is used as-is
AUTH_PASSWORD_HASH="$2a$12$xyz..."

# PROBLEM: No quotes — $2 is interpreted as a variable name
AUTH_PASSWORD_HASH=$2a$12$xyz...  # → becomes a$12$xyz... (broken)

# OK: Single quotes — no interpolation
AUTH_PASSWORD_HASH='$2a$12$xyz...'
...
MAX_REQUEST_SIZE_MB=5
AUTH_USERNAME=admin
AUTH_PASSWORD_HASH=$2a$12$...generated...
AUTH_SESSION_HOURS=8
