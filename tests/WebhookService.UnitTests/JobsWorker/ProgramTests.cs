...
namespace WebhookService.UnitTests.JobsWorker;

/// <summary>
/// Phase 3a tests — specify the JobsWorker host's DI contract.
/// RED until Phase 3b creates WebhookService.JobsWorker; these tests prove the
...
public sealed class ProgramTests
{
    ...
    public void JobsWorker_BindsWebhookOptions_WithRetentionDaysFromConfiguration()
    {
        ...
        var config = new ConfigurationBuilder()
            ...
            {
                ["Webhook:RetentionDays"] = "14"
            })
            .Build();

        services.Configure<WebhookOptions>(config.GetSection("Webhook"));
