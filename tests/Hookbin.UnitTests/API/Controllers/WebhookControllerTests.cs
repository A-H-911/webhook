...
public sealed class WebhookControllerTests
{
    ...
    private readonly IGeoIpService _geoIpService = Substitute.For<IGeoIpService>();
    ...
    {
        var controller = new WebhookController(_tokenRepo, _queuePublisher, _tokenCache, _geoIpService, _logger);
