...
public sealed class DtoMappingTests
{
    ...
    public void WebhookRequestSummaryDto_EqualityByValue()
    {
        ...
        var a = new WebhookRequestSummaryDto(id, tokenId, "POST", "/hook", receivedAt, "text/plain", 10, "1.2.3.4", null, null);
        var b = new WebhookRequestSummaryDto(id, tokenId, "POST", "/hook", receivedAt, "text/plain", 10, "1.2.3.4", null, null);
    ...
    public void WebhookRequestSummaryDto_InequalityWhenMethodDiffers()
    {
        ...
        var a = new WebhookRequestSummaryDto(id, tokenId, "POST", "/hook", receivedAt, null, 0, "1.1.1.1", null, null);
        var b = new WebhookRequestSummaryDto(id, tokenId, "GET", "/hook", receivedAt, null, 0, "1.1.1.1", null, null);
    ...
    public void WebhookRequestDetailDto_EqualityByValue()
    {
        ...
        var a = new WebhookRequestDetailDto(id, tokenId, "GET", "/x", null, receivedAt, null, "{}", null, false, 0, "1.1.1.1", null, null, null, null, null);
        var b = new WebhookRequestDetailDto(id, tokenId, "GET", "/x", null, receivedAt, null, "{}", null, false, 0, "1.1.1.1", null, null, null, null, null);
    ...
    public void PagedResult_AllProperties_AreAccessible()
    {
        ...
        {
            new(Guid.NewGuid(), Guid.NewGuid(), "POST", "/hook", DateTimeOffset.UtcNow, null, 0, "127.0.0.1", null, null)
        };
